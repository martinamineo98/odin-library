...
const createForm = (function () {
  ...
  const inputName = addInput('Name', 'book-name', 'book-name', form)
  const inputAuthor = addInput('Author', 'book-author', 'book-author', form)
  const inputPages = addInput('Pages', 'book-pages', 'book-pages', form, 'number')
  const inputRead = addInput('Read Status', 'book-read', 'book-read', form, 'checkbox')

  // Submit Button.

  const createSubmitBtn = (function () {
    const div = document.createElement('div')
    const btn = help.createElement('Submit', div, 'button')
    ...
    help.containerForm.appendChild(div)
  })()
})()
